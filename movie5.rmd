...
url_template <- 'https://www.imdb.com/title/tt10954600/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_5_imdb_reviews.csv", row.names = FALSE)
```
