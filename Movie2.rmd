...
url_template <- 'https://www.imdb.com/title/tt7961060/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_2_imdb_reviews.csv", row.names = FALSE)
```
