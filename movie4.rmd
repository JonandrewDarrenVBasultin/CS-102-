...
url_template <- 'https://www.imdb.com/title/tt1462764/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_4_imdb_reviews.csv", row.names = FALSE)
```
