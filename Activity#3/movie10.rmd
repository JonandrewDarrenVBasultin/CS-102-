...
url_template <- 'https://www.imdb.com/title/tt3450958/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_10_imdb_reviews.csv", row.names = FALSE)
```
