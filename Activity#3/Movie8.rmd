...
url_template <- 'https://www.imdb.com/title/tt0454876/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_8_imdb_reviews.csv", row.names = FALSE)
```
