...
url_template <- 'https://www.imdb.com/title/tt15314262/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_9_imdb_reviews.csv", row.names = FALSE)
```
