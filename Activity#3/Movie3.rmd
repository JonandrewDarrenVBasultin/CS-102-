...
url_template <- 'https://www.imdb.com/title/tt9362722/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "Movie_3_imdb_reviews.csv", row.names = FALSE)
```
